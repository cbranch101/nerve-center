...
////// Emissive:
                ...
                float4 node_5 = tex2D(_DOSText,TRANSFORM_TEX(node_393.rg, _DOSText));
                ...
                float3 emissive = (((((lerp((node_298_if_leA*tex2D(_DOSTextBlink,TRANSFORM_TEX(node_393.rg, _DOSTextBlink)).rgb)+(node_298_if_leB*node_5.rgb),node_5.rgb,node_298_if_leA*node_298_if_leB)*_ScreenImageBrightness)+(tex2D(_GradientGreenChannel,TRANSFORM_TEX(node_41, _GradientGreenChannel)).g*_ScanLinesIntensity))-((1.0 - tex2D(_Vignetting,TRANSFORM_TEX(node_171, _Vignetting)).rgb)*_VignettingIntensity))*tex2D(_ScanLinesRedChannel,TRANSFORM_TEX(node_393.rg, _ScanLinesRedChannel)).r)*_ScreenImageTint.rgb);
///////// Gloss:
