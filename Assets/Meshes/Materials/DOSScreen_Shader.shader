...
/*SF_DATA;ver:0.36;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:32328,y:32683|diff-2-RGB,spec-4-RGB,gloss-4-A,emission-238-OUT,amdfl-455-RGB,amspl-454-RGB;n:type:ShaderForge.SFN_Color,id:2,x:32718,y:32480,ptlb:Screen Color Off,ptin:_ScreenColorOff,glob:False,c1:0.051,c2:0.01,c3:0.01,c4:1;n:type:ShaderForge.SFN_Color,id:4,x:32844,y:32647,ptlb:Specularity,ptin:_Specularity,glob:False,c1:0.6911765,c2:0.6454368,c3:0.6454368,c4:0.4941176;n:type:ShaderForge.SFN_Tex2d,id:5,x:35010,y:32582,ptlb:DOS Text,ptin:_DOSText,tex:3cb4d9496949be647880a41c7b8c07f3,ntxv:2,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:11,x:34348,y:32947,ptlb:Gradient (Green Channel),ptin:_GradientGreenChannel,tex:f5f09cf8c1c80984dbf03fde029b55ae,ntxv:0,isnm:False|UVIN-41-UVOUT;n:type:ShaderForge.SFN_Add,id:12,x:33944,y:32783|A-227-OUT,B-28-OUT;n:type:ShaderForge.SFN_TexCoord,id:18,x:34998,y:32953,uv:0;n:type:ShaderForge.SFN_Multiply,id:28,x:34158,y:32947|A-11-G,B-30-OUT;n:type:ShaderForge.SFN_Slider,id:30,x:34326,y:33168,ptlb:Scan Lines Intensity,ptin:_ScanLinesIntensity,min:0,cur:0.25,max:1;n:type:ShaderForge.SFN_Panner,id:41,x:34547,y:32955,spu:1,spv:1|UVIN-18-UVOUT,DIST-81-OUT;n:type:ShaderForge.SFN_Time,id:70,x:34998,y:33409;n:type:ShaderForge.SFN_Multiply,id:81,x:34748,y:33273|A-198-OUT,B-70-T;n:type:ShaderForge.SFN_Subtract,id:131,x:33516,y:32852|A-12-OUT,B-139-OUT;n:type:ShaderForge.SFN_Tex2d,id:132,x:34218,y:33636,ptlb:Vignetting,ptin:_Vignetting,tex:4416db42cf2b3cd48a38e51a55ca0bd9,ntxv:0,isnm:False|UVIN-171-OUT;n:type:ShaderForge.SFN_Multiply,id:139,x:33750,y:33636|A-437-OUT,B-142-OUT;n:type:ShaderForge.SFN_Slider,id:142,x:33671,y:33812,ptlb:Vignetting Intensity,ptin:_VignettingIntensity,min:0,cur:0.5,max:1.25;n:type:ShaderForge.SFN_TexCoord,id:155,x:34856,y:33636,uv:0;n:type:ShaderForge.SFN_Multiply,id:156,x:34628,y:33636|A-155-UVOUT,B-157-OUT;n:type:ShaderForge.SFN_Vector1,id:157,x:34628,y:33772,v1:0.6;n:type:ShaderForge.SFN_Vector1,id:164,x:34424,y:33772,v1:0.2;n:type:ShaderForge.SFN_Add,id:171,x:34424,y:33636|A-156-OUT,B-164-OUT;n:type:ShaderForge.SFN_Exp,id:184,x:35137,y:33155,et:1|IN-213-OUT;n:type:ShaderForge.SFN_Subtract,id:198,x:34961,y:33188|A-184-OUT,B-199-OUT;n:type:ShaderForge.SFN_Vector1,id:199,x:35156,y:33332,v1:1;n:type:ShaderForge.SFN_ValueProperty,id:213,x:35366,y:33097,ptlb:Scan Lines Speed,ptin:_ScanLinesSpeed,glob:False,v1:1;n:type:ShaderForge.SFN_Multiply,id:227,x:34219,y:32686|A-298-OUT,B-228-OUT;n:type:ShaderForge.SFN_ValueProperty,id:228,x:34219,y:32845,ptlb:Screen Image Brightness,ptin:_ScreenImageBrightness,glob:False,v1:1.25;n:type:ShaderForge.SFN_Multiply,id:238,x:33002,y:32852|A-261-OUT,B-239-RGB;n:type:ShaderForge.SFN_Color,id:239,x:33002,y:33038,ptlb:Screen Image Tint,ptin:_ScreenImageTint,glob:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:261,x:33266,y:32852|A-131-OUT,B-262-R;n:type:ShaderForge.SFN_Tex2d,id:262,x:33266,y:33027,ptlb:Scan Lines (Red Channel),ptin:_ScanLinesRedChannel,tex:f5f09cf8c1c80984dbf03fde029b55ae,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Time,id:280,x:35406,y:32278;n:type:ShaderForge.SFN_If,id:298,x:34560,y:32582|A-299-OUT,B-300-OUT,GT-5-RGB,EQ-5-RGB,LT-380-RGB;n:type:ShaderForge.SFN_Frac,id:299,x:35214,y:32278|IN-280-T;n:type:ShaderForge.SFN_Vector1,id:300,x:35195,y:32444,v1:0.5;n:type:ShaderForge.SFN_Tex2d,id:380,x:35010,y:32756,ptlb:DOS Text Blink,ptin:_DOSTextBlink,tex:099b94d5c825bef46a4afc330e61244b,ntxv:2,isnm:False;n:type:ShaderForge.SFN_OneMinus,id:437,x:33978,y:33636|IN-132-RGB;n:type:ShaderForge.SFN_SkyshopSpec,id:454,x:32228,y:33275,sprot:True,spblend:True,splmocc:False|GLOSS-4-A;n:type:ShaderForge.SFN_SkyshopDiff,id:455,x:33028,y:33262,dfrot:True,dfblend:True,dflmocc:False;proporder:5-380-239-228-2-4-11-30-213-132-142-262;pass:END;sub:END;*/
...
////// Emissive:
                ...
                float2 node_470 = i.uv0;
                float4 node_5 = tex2D(_DOSText,TRANSFORM_TEX(node_470.rg, _DOSText));
                ...
                float3 emissive = (((((lerp((node_298_if_leA*tex2D(_DOSTextBlink,TRANSFORM_TEX(node_470.rg, _DOSTextBlink)).rgb)+(node_298_if_leB*node_5.rgb),node_5.rgb,node_298_if_leA*node_298_if_leB)*_ScreenImageBrightness)+(tex2D(_GradientGreenChannel,TRANSFORM_TEX(node_41, _GradientGreenChannel)).g*_ScanLinesIntensity))-((1.0 - tex2D(_Vignetting,TRANSFORM_TEX(node_171, _Vignetting)).rgb)*_VignettingIntensity))*tex2D(_ScanLinesRedChannel,TRANSFORM_TEX(node_470.rg, _ScanLinesRedChannel)).r)*_ScreenImageTint.rgb);
///////// Gloss:
