...
////// Emissive:
                float2 node_918 = i.uv0;
                float4 node_2 = tex2D(_ScreenImage,TRANSFORM_TEX(node_918.rg, _ScreenImage));
                float4 node_919 = _Time + _TimeEditor;
                float2 node_107 = (((-1*_ScanlinesTiling)*i.uv0.rg)+node_919.g*float2(0,-1));
