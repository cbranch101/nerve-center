...
////// Emissive:
                ...
                float3 emissive = clamp(((pow(tex2D(_Gradient,TRANSFORM_TEX(node_349, _Gradient)).g,_FlashTime)*step(tex2D(_Gradient,TRANSFORM_TEX(node_676.rg, _Gradient)).b,0.5))*_LightColor_Brightness.rgb*(_LightColor_Brightness.a*8.0)),0,1.5);
///////// Gloss:
